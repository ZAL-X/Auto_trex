...
function setup() {
  ...
  trex.addImage("jumping", trex_jump)
  trex.scale = 0.5;
  ...
  trexAuto=createSprite(100,170,1,100)
  trexAuto.visible=false
  trexAuto.setCollider("rectangle",0,0,1,100);
  trexAuto.debug = false
}
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //jhghjghjghjghgjhjghgjhjghjghjghjgaasdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsd
    if (obstaclesGroup.isTouching(trexAuto)&& trex.isTouching(ground)) {
      trex.velocityY = -12;
      jumpSound.play();
  ...
  trexAuto.collide(invisibleGround);
